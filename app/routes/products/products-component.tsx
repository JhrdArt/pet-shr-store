...
const ProductComponent: React.FC<Props> = ({ products, nameComponent, sectionData }) => {
  ...
  const [filteredProducts, setFilteredProducts] =
    useState<Product[]>(productCurrentCategory);
    ...
    const applyFiltersAndSorting = () => {
      ...
      switch (selectValue) {
        ...
        case "recommended":
          ...
          if (result.length === 0) {
            result = [...productCurrentCategory].sort((a, b) => b.rating - a.rating);
          }
          break;
      }
  ...
  }, [selectBrandValue, searchTerm, selectValue, productCurrentCategory, cartProducts]);
